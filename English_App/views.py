...
def my_form_view(request):
    if request.method == 'POST':
        ...
        return redirect(reverse_lazy( 'soufianemainpage'))  # Assuming 'home' is the name of your homepage URL pattern
    else:
        # Render your form template if the request method is GET
        return render(request, '/English_App/soufianemainpage.html')
...
def coaching(request):
    return render(request, 'English_App/coaching.html')

def iamthepromotor(request):
    return render(request, 'English_App/iamthepromoter.html')



def facepage(request):
    return render(request, 'English_App/facepage.html')

def container(request):
    return render(request, 'English_App/container.html')


def englishCoursesBac(request):
    return render(request, 'English_App/englishcoursesBac.html')

def newmainpage(request):
    return render(request, 'English_App/newmainpage.html')

def soufianemainpage(request):
    return render(request, 'English_App/soufianemainpage.html')
...
def displayContactInfo(request):
    ...
    return render(request,'English_App/displayContactInfo.html',{'contactme':ContactInfo})
...
def contactPost(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            return render(request, 'English_App/contactus.html')
    ...
    return render(request, 'English_App/contactus.html',context)
...
def updateUserArticle(request, id):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			form.save()
			return redirect('soufianemainpage')
