...
urlpatterns = [
path('my_form_view/', user_views.my_form_view, name='my_form_view'),
path('iamthepromotor', user_views.iamthepromotor, name='iamthepromotor'),
 path('container', user_views.container, name='container'),
 path('facepage', views.facepage, name ='facepage'),
 path('englishcoursesBac',views.englishCoursesBac,name='englishCoursesBac'),
 path('', views.index, name="index"),
 path('newmainpage', views.newmainpage, name="newmainpage"),
 path('soufianemainpage', views.soufianemainpage, name="soufianemainpage"),
 path('upload_video', views.video, name="upload_video"),
 path('news', views.news, name="news"),
 path('addfile', views.add_file, name ='addfile'),
 path('coaching', user_views.coaching, name='coaching'),
